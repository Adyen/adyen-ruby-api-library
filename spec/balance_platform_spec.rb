...
RSpec.describe Adyen::BalancePlatform, service: 'balancePlatform' do
  ...
  it 'makes a create_transfer_limit POST call' do
    ...
    result = @shared_values[:client].balance_platform.transfer_limits_balance_platform_level_api.create_transfer_limit(request_body, balance_platform_id)
    response_hash = result.response
 ...
 it 'makes a get_transfer_limits GET call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_platform_level_api.get_transfer_limits(balance_platform_id)
   response_hash = result.response
 ...
 it 'makes a get_specific_transfer_limit GET call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_platform_level_api.get_specific_transfer_limit(balance_platform_id, transfer_limit_id)
   response_hash = result.response
 ...
 it 'makes a delete_pending_transfer_limit DELETE call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_platform_level_api.delete_pending_transfer_limit(balance_platform_id, transfer_limit_id)
  ...
  it 'makes a create_transfer_limit POST call' do
    ...
    result = @shared_values[:client].balance_platform.transfer_limits_balance_account_level_api.create_transfer_limit(request_body, balance_account_id)
    response_hash = result.response
 ...
 it 'makes a get_transfer_limits GET call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_account_level_api.get_transfer_limits(balance_account_id)
   response_hash = result.response
 ...
 it 'makes a get_specific_transfer_limit GET call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_account_level_api.get_specific_transfer_limit(balance_account_id, transfer_limit_id)
   response_hash = result.response
 ...
 it 'makes a delete_pending_transfer_limit DELETE call' do
   ...
   result = @shared_values[:client].balance_platform.transfer_limits_balance_account_level_api.delete_pending_transfer_limit(balance_account_id, transfer_limit_id)

   expect(result.status).to eq(204)
 end

  it 'makes a approve_pending_transfer_limits POST call' do
    ...
    result = @shared_values[:client].balance_platform.transfer_limits_balance_account_level_api.approve_pending_transfer_limits(request_body, balance_account_id)
    response_hash = result.response
 ...
 it 'makes a create_webhook_setting POST call' do
   ...
   result = @shared_values[:client].balance_platform.balances_api.create_webhook_setting(request_body, balance_platform_id, webhook_id)
   response_hash = result.response
 ...
 it 'makes a delete_webhook_setting DELETE call' do
   ...
   result = @shared_values[:client].balance_platform.balances_api.delete_webhook_setting(balance_platform_id, webhook_id, setting_id)
 ...
 it 'makes a get_all_webhook_settings GET call' do
   ...
   result = @shared_values[:client].balance_platform.balances_api.get_all_webhook_settings(balance_platform_id, webhook_id)
   response_hash = result.response
 ...
 it 'makes a get_all_authorised_card_users GET call' do
   ...
   result = @shared_values[:client].balance_platform.authorized_card_users_api.get_all_authorised_card_users(payment_instrument_id)
   response_hash = result.response
