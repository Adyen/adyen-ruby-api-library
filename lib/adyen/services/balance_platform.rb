...
module Adyen
  class BalancePlatform < Service
    ...
    def get_transactions(balance_account_id, request)
      action = { method: 'get', url: "transactions?balanceAccountId=" + balance_account_id }

      @client.call_adyen_api(@service, action, request, {}, 2)
    end
