...
module Adyen
  class PaymentMethodsMerchantLevelApi < Service
    ...
    def get_payment_method_details(merchantId, paymentMethodId, headers: {})
      ...
      endpoint = endpoint.gsub(%r{^/}, '')
      endpoint = format(endpoint, merchantId, paymentMethodId)
    ...
    def get_apple_pay_domains(merchantId, paymentMethodId, headers: {})
      endpoint = '/merchants/{merchantId}/paymentMethodSettings/{paymentMethodId}/getApplePayDomains'.gsub(/{.+?}/,
                                                                                                           '%s')
      endpoint = endpoint.gsub(%r{^/}, '')
      endpoint = format(endpoint, merchantId, paymentMethodId)
    ...
    def add_apple_pay_domain(request, merchantId, paymentMethodId, headers: {})
      endpoint = '/merchants/{merchantId}/paymentMethodSettings/{paymentMethodId}/addApplePayDomains'.gsub(/{.+?}/,
                                                                                                           '%s')
      endpoint = endpoint.gsub(%r{^/}, '')
      endpoint = format(endpoint, merchantId, paymentMethodId)
